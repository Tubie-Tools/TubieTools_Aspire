...
namespace TubieTools_Machine_Learning
{
    ...
    {
        /// <summary>
        /// model input class for ReviewModel.
        /// </summary>
        ...
        /// <summary>
        /// model output class for ReviewModel.
        /// </summary>
        #region model output class
        public class ModelOutput
        {
            [ColumnName(@"star_rating")]
            public uint Star_rating { get; set; }
        ...
        private static string MLNetModelPath = Path.GetFullPath("ReviewModel.mlnet");
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("star_rating");
            if (labelColumn == null)
            {
                throw new Exception("star_rating column not found. Make sure the name searched for matches the name in the schema.");
            }
