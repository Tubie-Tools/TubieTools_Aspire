...
namespace TubieTools_Machine_Learning
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\xeque\Downloads\EtsySoldOrderItems2026.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Forecasting.ForecastBySsa(windowSize:2,seriesLength:10,trainSize:102,horizon:50,outputColumnName:@"Price",inputColumnName:@"Price",confidenceLowerBoundColumn:@"Price_LB",confidenceUpperBoundColumn:@"Price_UB");
